<script lang="ts">
	 ...
	 *
	 * One line changed from Pushed: the reassurance now points at the standing
	 * rail, because for the first time the empty state HAS somewhere to go — the
	 * rail's project slot opens the index of every project. Pushed conceded that
	 * when nothing runs there is no way up at all; this sentence is where that
	 * concession is answered out loud rather than left for the reader to find.
	 */
...
<section class="empty" aria-label="Nothing running">
	...
	<p class="reassurance">
		...
		starts. The rail below still goes somewhere: every project is a tap away.
	</p>
	<p class="pulse">
