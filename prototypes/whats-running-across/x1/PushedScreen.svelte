...
<style>
	...
	.column {
		...
		min-height: 0;
		padding: var(--space-4);
		/* Clears the standing rail, which is fixed over every screen and carries
		   the prototyping harness's pager clearance inside it. Declared once on
		   the page root and inherited here, so a pushed screen and the running
		   view pay the identical price. */
