...
>
	<span class="row" class:selected>
		...
		<span class="identity">
			...
			<span class="context">
				{#if showRelease}<span class="release">{task.release}</span
					><span class="sep">·</span>{/if}<span class="project">{task.project}</span><span
					class="sep">·</span
				><span class="phase">phase {task.phase}</span><span class="sep">·</span><span class="type"
					>{task.type}</span
				>
			</span>
		</span>
