...
export const tasks: Task[] = [
	...
	// alfons-mcp — the sibling release, so switching the rail shows real material.
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'public.css and admin.css are generated from one token source.',
				verdict: 'pass'
			},
	...
	},
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'Literal colours and lengths are flagged where a token exists.',
				verdict: 'pass'
			},
			{
				id: 'C2',
				body: 'Layout nesting reads the same ordering as get_layout_recipe.',
				verdict: 'pass'
			},
		...
		steps: [
			'Parse the source',
			'Match against the token table',
			'Read the layout tiers',
			'Emit positions'
		],
	...
	},
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'Public surfaces have a status indicator that is not admin-scoped.',
				verdict: 'fail'
			},
			{
				id: 'C2',
				body: 'The indicator carries a shape or label, never colour alone.',
				verdict: null
			}
		],
		steps: [
			'Audit public status usage',
			'Design the public mark',
			'Port StatusBadge',
			'Deprecate the admin one'
		],
		fileChanges: [],
		dependsOn: ['AL-004']
	},
	...
	// A scattering across other releases so search crosses project boundaries.
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'The repo path comes from projects.repo_path, never from the caller.',
				verdict: 'pass'
			},
		...
		steps: [
			...
			'Look up repo_path',
			'Compare to the release slug',
			'Fail open on unknowable cases'
		],
		fileChanges: [
			'src/ledger_mcp/worktree.py',
			'src/ledger_mcp/validation.py',
	...
	},
	{
		...
		criteria: [
			...
			{
				id: 'C3',
				body: "The search vector wraps its input in translate(..., '<>', '  ').",
				verdict: null
			}
		],
	...
	},
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'A token is scoped to one surface and cannot be replayed at another.',
				verdict: null
			},
	...
	},
	{
		...
		criteria: [
			{
				id: 'C1',
				body: 'Figures wear the display serif; labels wear mono microtype.',
				verdict: 'pass'
			},
			{
				id: 'C2',
				body: 'More than three figures is refused by review, not by the component.',
				verdict: 'pass'
			}
		],
...
export const transitionFeed: TransitionEvent[] = [
	...
	{
		taskId: 'ATL-118',
		title: 'Caddy mount for the dev surface',
		from: 'pending',
		to: 'triaged',
		at: '13:31'
	},
	{
		taskId: 'AL-009',
		title: 'Retire the duplicated status indicator',
		from: 'verifying',
		to: 'blocked',
		at: '12:58'
	}
