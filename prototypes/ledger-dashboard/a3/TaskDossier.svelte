...
<section class="dossier" aria-label="Task dossier">
	...
	{:else}
		...
		<dl class="facts">
			<div><dt>Release</dt><dd>{task.release}</dd></div>
			<div><dt>Project</dt><dd>{task.project}</dd></div>
			<div><dt>Created</dt><dd>{task.createdOn}</dd></div>
			<div><dt>Completed</dt><dd>{task.completedOn ?? '—'}</dd></div>
			<div>
				<dt>Latest seal</dt>
				<dd>
		...
		<section class="block">
			<h3 class="block-heading">Criteria <span class="block-count">{task.criteria.length}</span></h3>
			<ul class="criteria">
