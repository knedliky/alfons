<script lang="ts">
	...
	let { project, currentReleaseSlug }: { project: Project; currentReleaseSlug: string } = $props();
...
>
	...
	<ul class="releases">
		{#each held as release (release.slug)}
			<li class="release" aria-current={release.slug === currentReleaseSlug ? 'true' : undefined}>
