			...
			<Container maxWidth="full" padding={false}>
				<div class="legend">
					<div class="legend-block">
						...
						<p class="legend-note">
							Status sits in the frozen spine, so it is one of only three things always on screen.
							It carries a glyph and a word as well as its colour, which is what lets it survive
							that weight.
						</p>
					</div>
					...
					<div class="legend-block">
						...
						<dl class="legend-keys">
							...
							<div>
								<dt>Keys</dt>
								<dd>
									tab into the rail, then arrows to scroll either way, Home and End for the two ends
								</dd>
							</div>
							<div>
								<dt>Ph · Stp · Crt</dt>
