...
<script lang="ts">
	 ...
	 * The word's type comes from --ledger-rung-2-*, declared in the same place:
	 * a status is a locator, one of the strings you would say aloud to name
	 * where a piece of work stands, so it sits on the same rung as the id.
	 */
