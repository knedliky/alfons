	...
	<div style="height:420px;border:1px dashed var(--border-glass);border-radius:var(--radius);overflow:hidden">
		<PageLayout>
			...
			<div style="padding:3rem 2rem">
				<div style="padding:2rem;background:var(--accent-bg);border-radius:var(--radius)">
	...
	<div style="height:500px;border:1px dashed var(--border-glass);border-radius:var(--radius);overflow:auto">
		<PageLayout>
			...
			<div style="padding:2rem;display:flex;flex-direction:column;gap:1rem">
				<div style="padding:2rem;background:var(--accent-bg);border-radius:var(--radius)">Hero section</div>
				<div style="padding:1.5rem;background:var(--accent-bg);border-radius:var(--radius)">Feature section</div>
				<div style="padding:1.5rem;background:var(--accent-bg);border-radius:var(--radius)">CTA section</div>
			</div>
		</PageLayout>
	</div>
</Story>
